	  ...
	  render: function render() /*object*/{
	    ...
	    for (var i = 0; i < rowsToRender.length; ++i) {
	      ...
	      this._staticRowArray[i] = React.createElement(FixedDataTableRow, {
	        ...
	        onTouchTap: props.onRowTouchTap,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTableRowImpl = React.createClass({
	  ...
	  propTypes: {
	    ...
	    /**
	     * Fire when a row is touch tapped.
	     */
	  ...
	  render: function render() /*object*/{
	    ...
	    return React.createElement(
	      'div',
	      {
	        ...
	        onTouchTap: this.props.onTouchTap ? this._onTouchTap : null,
	  ...
	  _onTouchTap: function _onTouchTap( /*object*/event) {
	    this.props.onTouchTap(event, this.props.index);
	  },
